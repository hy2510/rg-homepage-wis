        ...
        <div className={style.calendar_detail_mode_info_container}>
          ...
          <div className={style.daily_goal_info}>
            {/* <Image
              ...
              height="18"
            /> */}
            <span>{`(하루 +${settingValue}P 획득하기)`}</span>
          </div>
        </div>
      )}
        ...
        <div className={style.calendar_detail_mode_info_container}>
          ...
          <div className={style.daily_goal_info}>
            {/* <Image
              ...
              height="18"
            /> */}
            <span>{`(하루 ${settingValue}권씩 학습하기)`}</span>
          </div>
        </div>
      )}
    </div>
    ...
    <>
      ...
      <div className={style.cal_detail_mode_tabs}>
        <div
          ...
          <span>학습 권 수</span>
          {tabButtonStatus === 'passed' && <span>{monthlyBooks}권</span>}
        </div>
        <div
          className={`${style.tab_button} ${
      ...
      {events.reverse().map((event) => {
        return event.item.map((item, idx) => {
          ...
          switch (item.type) {
            ...
            case 'change':
              if (item.extra === 'book') {
                text = `목표변경 - 하루 ${item.value}권 읽기`
              } else if (item.extra === 'point') {
                text = `목표변경 - 하루 ${item.value}P 획득`
              }
              break
          }
