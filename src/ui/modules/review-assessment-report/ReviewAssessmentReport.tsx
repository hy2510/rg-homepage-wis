      ...
      <div className={style.review_assessment_report}>
        <div
          ...
          <div className={style.col_a_container}>
            ...
            <Book title={title} author={author || ''} bookImgSrc={bookImgSrc} />
            <div className={style.review}>
              <Button
                ...
                onClick={() => {
                  window?.open(
                    `http://ozreport.a1edu.com/OZ/ReadingAssessmentNew.aspx?args1=${studyId}args2=${studentHistoryId}args3=${customerId}`,
                  )
                }}>
                리포트 출력
              </Button>
